...
<p align="center">
  <img src="https://img.shields.io/badge/23343009-Network%20Programming-brightgreen?logo=github&logoColor=white" />
...
Struktur folder pada repository ini disusun berdasarkan **nomor dan topik JobSheet**
sesuai dengan ketentuan praktikum, dengan format:
...
Setiap folder JobSheet berisi **source code, konfigurasi, dan file pendukung**
sesuai dengan materi praktikum pada minggu tersebut.
...
| No | JobSheet | Topik |
|----|----------|-------|
| 1 | JobSheet 1 | Pengantar NodeJS |
| 2 | JobSheet 2 | Node.Js Module System |
| 3 | JobSheet 3 | HTTP Request and API |
| 4 | JobSheet 4 | JavaScript Essentials |
| 5 | JobSheet 5 | Web Server and ExpressJs |
...
- Repository ini digunakan untuk **penilaian progres mingguan praktikum**
- Repository untuk **UTS dan UAS akan dibuat terpisah** sesuai instruksi dosen
- Setiap JobSheet diupload sesuai jadwal dan ketentuan praktikum
